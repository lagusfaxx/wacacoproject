...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'IN_PROCESS', 'PREPARING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'FAILED');
...
CREATE TABLE "Order" (
    ...
    "shipCountry" TEXT NOT NULL DEFAULT 'CL',
    "notes" TEXT,
